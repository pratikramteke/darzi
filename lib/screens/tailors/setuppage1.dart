...
class _Setuppage1State extends State<Setuppage1> {
  ...
  List<String> dropdownitems = <String>['gents', 'ladies', 'both'];
  String t1;
  String t2;
  ...
  Widget _buildphoneno() {
    return TextFormField(
      ...
      validator: (val) =>
          val.length != 10 ? 'Please enter valid phone no' : null,
  ...
  Widget _buildspecialization() {
    return 
      ...
      RaisedButton(
        ...
        onPressed: _timedialog1,
      ),
      SizedBox(width:80.0),
      RaisedButton(
        child: Text('Closing Time'),
        onPressed: _timedialog2,
      ),
    ]);
